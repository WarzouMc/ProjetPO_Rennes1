...
public class Weapon {//cette classe définie tous les types d'armes différents
	...
	private int ammunitionsMax;//le nombre de munition initial de l'arme
	...
	public int getAmmunitionsMax() {
		return ammunitionsMax;
	}

	public void setAmmunitionsMax(int ammunitionsMax) {
		this.ammunitionsMax = ammunitionsMax;
	}
