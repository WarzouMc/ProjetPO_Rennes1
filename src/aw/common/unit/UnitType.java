...
import aw.common.unit.impl.aerien.Bombarder;
import aw.common.unit.impl.aerien.Helico;
...
public enum UnitType {
    ...
    GROUND_AIR_ML("Lance-missile Sol-Air", Chemins.FICHIER_GROUND_AIR_ML, SubType.CHENILLE, new GroundAirML()),
	;
	 ...
	 */
	public enum SubType {
        FOOT(new int[] {1, 1, 1, 1, 1, 2, 0}),
        CHENILLE(new int[] {1, 1, 1, 1, 2, 0, 0}),
