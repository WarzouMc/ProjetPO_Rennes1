...
public class Chemins {
 ...
 /** Nom de la carte 1 donnee en exemple */
    ...
    /** Nom du fichier de l'image de l'unite lance-missile sol-air Ce fichier existe dans plusieurs repertoires correspondants a  la couleur de l'unite et si elle est disponible ou non*/
    public static final String FICHIER_GROUND_AIR_ML = "antiair.png";
/** Nom du fichier de l'image de l'unite anti-air. Ce fichier existe dans plusieurs repertoires correspondants a  la couleur de l'unite et si elle est disponible ou non*/
    ...
    public static final String FICHIER_CROISEUR = "cruiser.png";
    public static final String FICHIER_CORVETTE = "bateau2.png";
    public static final String FICHIER_BARGE = "barge.png";
    public static final String FICHIER_PORTE_AVION = "porte-avion.png";
    public static final String FICHIER_CUIRASSIER = "bateau1.png";
    public static final String FICHIER_SOUS_MARIN = "submarine.png";
